 ...
 ******************************************************************************/
extern uint8_t DisplayBuff[12],ModifyNumber;
extern stc_rtc_time_t RtcTime;
extern stc_rtc_alarmtime_t Clock1,Clock2,Clock3,Clock4,Clock5;
...
extern en_result_t Lcd_CleanRamBit(uint8_t u8Row,uint32_t u32Data);
void TimerDisplay(uint8_t *Number,uint8_t State);
extern void App_PortCfg(void);
extern void App_LcdCfg(void);
