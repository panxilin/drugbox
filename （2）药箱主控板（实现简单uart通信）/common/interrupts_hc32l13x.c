...
__WEAKDEF void PortA_IRQHandler(void);
__WEAKDEF void PortB_IRQHandler(void);
__WEAKDEF void PortC_IRQHandler(void);
__WEAKDEF void PortD_IRQHandler(void);
__WEAKDEF void Dmac_IRQHandler(void);
__WEAKDEF void Tim3_IRQHandler(void);
__WEAKDEF void Uart0_IRQHandler(void);
__WEAKDEF void Uart1_IRQHandler(void);
__WEAKDEF void LpUart0_IRQHandler(void);
__WEAKDEF void LpUart1_IRQHandler(void);
__WEAKDEF void Spi0_IRQHandler(void);
__WEAKDEF void Spi1_IRQHandler(void);
__WEAKDEF void I2c0_IRQHandler(void);
__WEAKDEF void I2c1_IRQHandler(void);
__WEAKDEF void Tim0_IRQHandler(void);
__WEAKDEF void Tim1_IRQHandler(void);
__WEAKDEF void Tim2_IRQHandler(void);
__WEAKDEF void LpTim_IRQHandler(void);
__WEAKDEF void Tim4_IRQHandler(void);
__WEAKDEF void Tim5_IRQHandler(void);
__WEAKDEF void Tim6_IRQHandler(void);
__WEAKDEF void Pca_IRQHandler(void);
__WEAKDEF void Wdt_IRQHandler(void);
__WEAKDEF void Rtc_IRQHandler(void);
__WEAKDEF void Adc_IRQHandler(void);
__WEAKDEF void Dac_IRQHandler(void);
__WEAKDEF void Pcnt_IRQHandler(void);
__WEAKDEF void Vc0_IRQHandler(void);
__WEAKDEF void Vc1_IRQHandler(void);
__WEAKDEF void Lvd_IRQHandler(void);
__WEAKDEF void Lcd_IRQHandler(void);
__WEAKDEF void Flash_IRQHandler(void);
__WEAKDEF void Ram_IRQHandler(void);
__WEAKDEF void ClkTrim_IRQHandler(void);
